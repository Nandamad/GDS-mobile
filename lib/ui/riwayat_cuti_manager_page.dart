...
class RiwayatCutiManagerScreen extends StatefulWidget {
  const RiwayatCutiManagerScreen({super.key});

  @override
  State<RiwayatCutiManagerScreen> createState() => _RiwayatCutiManagerScreenState();
}

class _RiwayatCutiManagerScreenState extends State<RiwayatCutiManagerScreen> {
            ...
            child: _isLoading
                ...
                : _errorMessage != null
                    ...
                    : _filteredList.isEmpty
                        ? const Center(child: Text('Tidak ada riwayat cuti.', style: TextStyle(color: Colors.grey)))
                        : RefreshIndicator(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              const Text('Tipe / Durasi', style: TextStyle(fontSize: 12, color: Colors.grey)),
              Text('$tipe • $durasi', style: const TextStyle(fontSize: 12, fontWeight: FontWeight.bold, color: Color(0xFF0F172A))),
            ],
          ),
          ...
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              const Text('Periode', style: TextStyle(fontSize: 12, color: Colors.grey)),
              Text(tanggal, style: const TextStyle(fontSize: 12, fontWeight: FontWeight.bold, color: Color(0xFF0F172A))),
            ],
          ),
          const SizedBox(height: 12),
          const Text('Alasan & Catatan Tinjauan', style: TextStyle(fontSize: 12, color: Colors.grey)),
