      ...
      if (lemburRes.statusCode == 200) {
        ...
        if (lemburPayload['data'] is List) {
          ...
          _riwayatLembur.sort((a, b) {
            final dateA =
                DateTime.tryParse(a['tanggal'] ?? '') ?? DateTime.now();
            final dateB =
                DateTime.tryParse(b['tanggal'] ?? '') ?? DateTime.now();
        ...
        children: [
          Row(
            ...
            children: [
              ...
              Text(
                _attendanceSummary['total_menit_kerja'] != null
                    ? '${(_attendanceSummary['total_menit_kerja'] / 60).floor()}j ${(_attendanceSummary['total_menit_kerja'] % 60)}m'
        ...
        children: [
          ...
          if (_riwayatLembur.isEmpty)
            const Padding(
              ...
              child: Center(
                child: Text(
                  'Belum ada riwayat lembur bulan ini',
